  ...
  var X = {
    ...
    updateSlidesClasses: function () {
      ...
      if (r)
        ...
        n
          ? ((o = t.find((e) => e.column === i)), (c = t.find((e) => e.column === i + 1)), (d = t.find((e) => e.column === i - 1)))
          : (o = t[i]);
      o &&
        (n ||
          ((c = (function (e, t) {
  ...
  var N = {
    ...
    slideNext: function (e, t, s) {
      ...
      if (r.loop) {
        ...
        if (
          (a.loopFix({ direction: "next" }), (a._clientLeft = a.wrapperEl.clientLeft), a.activeIndex === a.slides.length - 1 && r.cssMode)
        )
          return (
            requestAnimationFrame(() => {
  ...
  const ge = [
    ...
    function (e) {
      ...
      function c(e) {
        ...
        if (t.params.loop) {
          ...
          const e =
            ((i = t.realIndex), (r = a), (n = t.slides.length), (r %= n) == 1 + (i %= n) ? "next" : r === i - 1 ? "previous" : void 0);
    ...
    function (e) {
      ...
      function $(e) {
        ...
        if (
          (Math.max(Math.abs(b.touchesCurrent.x - b.touchesStart.x), Math.abs(b.touchesCurrent.y - b.touchesStart.y)) > 5 &&
            (t.allowClick = !1),
          !b.isMoved && !o)
        ) {
          if (
      ...
      const x = (e, t, s) => {
        ...
        P = (e) => {
          ...
          a ||
            ...
            requestAnimationFrame(() => {
              r ||
                (t.params.loop ? t.slideToLoop(parseInt(s.getAttribute("data-swiper-slide-index")), 0) : t.slideTo(t.slides.indexOf(s), 0),
                (r = !1));
            }));
        },
        L = () => {
